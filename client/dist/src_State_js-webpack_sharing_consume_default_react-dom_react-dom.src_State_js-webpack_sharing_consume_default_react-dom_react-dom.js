...
console.log("https://sars-cov-2-cb.herokuapp.com/");
...
const State = () => {
  ...
  const dataDefault = "https://sars-cov-2-cb.herokuapp.com/" + '/api/default';
  const dataCustomeDate = "https://sars-cov-2-cb.herokuapp.com/" + '/api/default/data=' + dateValue;
